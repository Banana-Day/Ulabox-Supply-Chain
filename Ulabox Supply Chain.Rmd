...
---
---------------------------------------------------------------
Kaggle URL: https://www.kaggle.com/anshumoudgil/ulabox-orders-discounts-consumer-behaviour/notebook
---------------------------------------------------------------
# Introduction
...
8 Categories: There are 8 categories and their columns represent "what percentage (or fraction) of total payment was made into each category?"

**Please Note:** Neither the Selling (or Cost) Price per product was given, nor the total payment made per order per customer was stated. This made me take some assumptions for the sake of this analysis. 
